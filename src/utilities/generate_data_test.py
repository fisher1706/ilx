...
class GenerateIDE856:
    ...
    def generate_data_edi_856_rtf(test_type):
        ...
        data = {
            ...
            7: f'BSN*{tran_id}{format(amt).zfill(3)}/129609',
            # 8: f'REF*GV*SIQTE-000-{_order_id}-001',
            8: f'BSN*GV*SIQTE-000-{_order_id}-001',
            9: 'REF*OQ*67951849',
            10: 'DTM*011*20211102',
        ...
        file_name = f'ANXEU_STOREROOM_LOGIX_EU_856_OB_19229744_{isa13}.edi'
...
if __name__ == '__main__':
    ...
    filename, data = g.generate_data_edi_856_rtf(test_type='pass')
