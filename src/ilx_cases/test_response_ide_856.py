...
def test_response_ide_856(ilx_context, number, test_type, testrail_case_id):
    ...
    Utils.upload_sftp_files(ilx_context.ilx_data.host_edi_856, ilx_context.user_name_edi_856,
                            ilx_context.password_edi_856, ilx_context.ilx_data.path_out,
                            ilx_context.ilx_data.inbox_edi_856)
    ...
    for data in test_data:
        ...
        #
        # resp = requests.get(url=Utils.generate_url_new(ilx_context.ilx_data.edi_856_url, case=case), headers=headers)
        #
        # print(resp.json())
