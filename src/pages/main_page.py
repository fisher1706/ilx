...
class MainBase:
    def __init__(self, ilx_context):
        ...
        self.__wait = WebDriverWait(self.ilx_driver, 5, 2)
        # ilx_test
        self.url_ilx = self.ilx_context.ilx_session_context.ilx_url
        # # srx_test
        self.srx_url = self.ilx_context.ilx_session_context.srx_url

        self.srx_email_dist = self.ilx_context.ilx_session_context.srx_email_dist
        self.srx_password_dist = self.ilx_context.ilx_session_context.srx_password_dist

        self.srx_email_customer = self.ilx_context.ilx_session_context.srx_email_customer
        self.srx_password_customer = self.ilx_context.ilx_session_context.srx_password_customer
        self.srx_auth = self.ilx_context.ilx_session_context.srx_auth

        self.srx_settings_email_search_product = self.ilx_context.ilx_session_context.srx_settings_email_search_product
        self.qa_token = self.ilx_context.ilx_session_context.ilx_qa_token
